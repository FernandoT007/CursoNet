...
using Estudiantes.Infrastructure.Extensions;
...
public static class DependencyInjection
{
    ...
    )
    {
        ...
        var payloadSizeLimit = configuration.GetValue<long>("PayloadSizeLimit");

        services.Configure<IISServerOptions>(options =>
        {
            options.MaxRequestBodySize = payloadSizeLimit;
        });
